...
import shoulderArthroscopy from './img/Shoulder.JPG';
import shoulderArthroscopy2 from './img/Shoulder1.JPG';
import Image from "next/image";

import Card from "@/components/card"

const ArthroscopyShoulder = () => {
    ...
    return (
      <Card>    <div className="text-start ">
        ...
        <div className='mb-4 flex flex-1 gap-20 justify-center'>
            <Image src={shoulderArthroscopy} alt="ocilating" className="hover:scale-150 duration-700 w-96 -ml-11" />
            <Image src={shoulderArthroscopy2} alt="ocilating" className="hover:scale-150 duration-700 w-96 -ml-11" />
          </div>
        <div className="mb-4">
...
export default ArthroscopyShoulder